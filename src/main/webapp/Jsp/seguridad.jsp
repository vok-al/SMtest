...
<html>
    ...
    <body>
            ...
            <nav>
                <section class="contenedor nav">
                    ...
                    <div class="enlaces-header">
                        <a href="../Html/SobreEmpresa.html">Conócenos</a>
                        <a href="..">Ubicación</a>
        ...
        <section class="content-area">
            ...
            <script
                src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBAz-N5sU93CUWjEfBdj8SSU95gsGxUvJA&callback=initMap&v=weekly"
                async
            ></script>
            <br><br>
